...
import com.hotmail.wolfiemario.rebalancevillagers.mcstats.Metrics;
...
public class RebalanceVillagers extends JavaPlugin implements Listener
{
    ...
    public void onEnable()
    {
        ...
        try
        {
            ...
            getLogger().info(
                    "Existing villagers have been reloaded as BalancedVillagers.");
    ...
    public void onCreatureSpawn(CreatureSpawnEvent event)
    {
        ...
        final net.minecraft.server.v1_7_R3.World mcWorld = ((CraftWorld) entity
                .getWorld()).getHandle();
        net.minecraft.server.v1_7_R3.Entity mcEntity = (((CraftEntity) entity)
                .getHandle());
        ...
        if (entityType == EntityType.VILLAGER)
        {
            ...
            if (!Arrays.equals(allowedProfessions, DEFAULT_ALLOWED_PROFESSIONS)) // If
                                                                                 ...
                                                                                 // professions,
                                                                                 // override
                entityVil.setProfession(allowedProfessions[new java.util.Random()
            ...
            if ((mcEntity instanceof BalancedVillager) == false)
            {
                ...
                if (ShopkeepersHelper.shopkeepersActive())
                {
                    Bukkit.getScheduler().runTaskAsynchronously(this,
                            new ShopkeeperWaiter(entityVil, mcWorld, this));
                }
                else
                {
    ...
    private void convertExistingVillagers()
    {
        ...
        for (World world : worldList)
        {
            ...
            net.minecraft.server.v1_7_R3.World mcWorld = ((CraftWorld) world).getHandle();
            
            for (Villager vil : villagerList)
            {
                // Detect Shopkeepers even on startup!
                if (!ShopkeepersHelper.shopkeepersActive()
                        || !ShopkeepersHelper.isShopkeeper(vil))
                {
                    EntityVillager entityVil = (EntityVillager) ((CraftEntity) vil)
                            .getHandle();
    ...
    public void convertVillager(EntityVillager vil,
            net.minecraft.server.v1_7_R3.World mcWorld)
    {
